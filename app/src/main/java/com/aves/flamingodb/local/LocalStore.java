...
import com.aves.flamingodb.bundle.BundleCallback;
...
import com.aves.flamingodb.core.TargetIdGenerator;
  ...
  public LocalDocumentsResult writeLocally(List<Mutation> mutations) {
    ...
    return persistence.runTransaction(
        ...
        () -> {
          ...
          for (Entry<DocumentKey, MutableDocument> entry : remoteDocs.entrySet()) {
  ...
  public ImmutableSortedMap<DocumentKey, Document> applyRemoteEvent(RemoteEvent remoteEvent) {
    ...
    return persistence.runTransaction(
        ...
        () -> {
          ...
          for (Entry<Integer, TargetChange> entry : targetChanges.entrySet()) {
